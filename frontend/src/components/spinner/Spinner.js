...
const SVG_CONTENT = `<g>
    <g transform="translate(82,50)">
        <g transform="rotate(0)">
            <circle cx="0" cy="0" r="10" fill="@color" fill-opacity="1" transform="scale(1.05253 1.05253)">
    ...
    <g transform="translate(72.62741699796952,72.62741699796952)">
        <g transform="rotate(45)">
            <circle cx="0" cy="0" r="10" fill="@color" fill-opacity="0.875" transform="scale(1.06503 1.06503)">
    ...
    <g transform="translate(50,82)">
        <g transform="rotate(90)">
            <circle cx="0" cy="0" r="10" fill="@color" fill-opacity="0.75" transform="scale(1.07753 1.07753)">
    ...
    <g transform="translate(27.37258300203048,72.62741699796952)">
        <g transform="rotate(135)">
            <circle cx="0" cy="0" r="10" fill="@color" fill-opacity="0.625" transform="scale(1.09003 1.09003)">
    ...
    <g transform="translate(18,50.00000000000001)">
        <g transform="rotate(180)">
            <circle cx="0" cy="0" r="10" fill="@color" fill-opacity="0.5" transform="scale(1.00253 1.00253)">
    ...
    <g transform="translate(27.372583002030474,27.37258300203048)">
        <g transform="rotate(225)">
            <circle cx="0" cy="0" r="10" fill="@color" fill-opacity="0.375" transform="scale(1.01503 1.01503)">
    ...
    <g transform="translate(49.99999999999999,18)">
        <g transform="rotate(270)">
            <circle cx="0" cy="0" r="10" fill="@color" fill-opacity="0.25" transform="scale(1.02753 1.02753)">
    ...
    <g transform="translate(72.62741699796952,27.372583002030474)">
        <g transform="rotate(315)">
            <circle cx="0" cy="0" r="10" fill="@color" fill-opacity="0.125" transform="scale(1.04003 1.04003)">
